...
import com.change.server.TCPServer;
...
public class StageFactory {
    ...
    private Scene buildScene(EnumScenes scene){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(TCPServer.class.getResource("views/"+scene.getFileName()));
            Scene newScene = new Scene(fxmlLoader.load(), 320, 200);
